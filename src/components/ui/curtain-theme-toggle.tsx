...
const TOKENS: Record<Theme, Record<string, string>> = {
  light: {
    pageBg:    "#f0f4f4", // match --theme-darker in globals.css
    pageText:  "#0a1211", // match --theme-white
    barBg:     "#ffffff",
    barText:   "#0a1211",
    barBorder: "rgba(0,0,0,0.1)",
    btnBg:     "#ffffff",
    btnText:   "#0a1211",
    btnRing:   "rgba(0,0,0,0.1)",
    inputBg:   "rgba(0,0,0,0.05)",
    inputText: "#0a1211",
  },
  dark: {
    pageBg:    "#040807", // match --theme-darker
    pageText:  "#ffffff", // match --theme-white
    barBg:     "#0a1211",
    barText:   "#ffffff",
...
export function ThemeToggle({
  ...
  // Mark as mounted (client-side only) for portal
  useEffect(() => {
  ...
  const curtainStyle: CSSProperties = {
    ...
    transformOrigin: phase === "rising" ? "top" : "bottom",
  ...
  // Curtain rendered via portal so it always covers the full viewport
  const curtainPortal = isMounted
    ? createPortal(
  ...
  return (
    <div style={pageStyle}>
      {/* Curtain overlay via portal — always full-screen */}
      {curtainPortal}
